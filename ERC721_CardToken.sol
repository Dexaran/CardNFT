...
contract ERC721 {
    ...
    address public contract_owner = 0xc9Bea9379A8Fade01240eE583535faC713B71014; // TO BE REPLACED WITH ACTUAL ADDRESS
    ...
    // Token name
    string public _name = "Test NFT";

    // Token symbol
    string public _symbol = "TNFT";
    ...
    */
    ...
    modifier only_token_creator
    {
        require(_tokenCreators[msg.sender]);
        _;
    }
}
